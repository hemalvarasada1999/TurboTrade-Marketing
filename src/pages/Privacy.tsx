...
const Privacy = () => {
    return (
        <LegalPageLayout
            ...
            description="Effective Date: 1st December, 2025 | Last Updated: 1st December, 2025"
        >
            <div className="space-y-4">
                {/* Introduction */}
                <Card className="p-5 sm:p-6 bg-card border-border shadow-sm">
                    <h2 className="text-base sm:text-lg font-semibold mb-2 text-primary flex items-center gap-2">
                        1. Introduction
                    </h2>
                    <div className="space-y-3 text-xs sm:text-sm text-foreground/90 leading-relaxed">
                            ...
                            <Card className="p-5 sm:p-6 bg-card border-border shadow-sm">
                                ...
                                <div className="prose max-w-none space-y-2 text-muted-foreground leading-relaxed">
                                    ...
                                    <p>Email: <a href="mailto:inquiry@turbotrade.ai" className="text-accent hover:underline font-medium transition-colors">inquiry@turbotrade.ai</a></p>
                                </div>
                            </Card>
                            ...
                            <Card className="p-5 sm:p-6 bg-card border-border shadow-sm">
                                ...
                                <div className="prose max-w-none space-y-4 text-muted-foreground leading-relaxed">
                                    ...
                                    <ul className="list-disc list-inside space-y-1 ml-4">
                                        ...
                                        <li>Contacting inquiry@turbotrade.ai</li>
                                    </ul>
                            ...
                            <Card className="p-5 sm:p-6 bg-card border-border shadow-sm">
                                ...
                                <div className="prose max-w-none space-y-4 text-muted-foreground leading-relaxed">
                                    <p>
                                        For any concerns, queries, or rights requests regarding this Privacy Policy or data processing, please email: <a href="mailto:inquiry@turbotrade.ai" className="text-accent hover:underline font-medium transition-colors">inquiry@turbotrade.ai</a>
                                    </p>
                                </div>
                            </Card>
            </div>
